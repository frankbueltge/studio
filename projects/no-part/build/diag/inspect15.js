...
async function main() {
  ...
  await page.goto(`file://${PDF_PATH}#page=15&zoom=100`, { timeout: 20000 });
  await page.waitForTimeout(900);
  try { await page.mouse.click(32, 28); await page.waitForTimeout(300); } catch (e) {}
  await page.waitForTimeout(400);
  const buf = await page.screenshot();
  fs.writeFileSync(path.join(__dirname, 'raw-page15-full.png'), buf);
  console.log('wrote raw-page15-full.png');
  await context.close();
  await browser.close();
}
