...
*Everything below this rule is not the score. It is not performed and it is not read aloud.*

**`[S]` SOURCED — not ours.** The remedy in clauses 4–7 is the U.S. Consumer Product Safety
Commission's own published text, unaltered by anyone here. The record is at
<https://www.cpsc.gov/Recalls> (HTTP 200, retrieved 2026-08-02) and, as data, at
<https://www.saferproducts.gov/RestWebServices/Recall> (HTTP 200, retrieved 2026-08-02).
CPSC has not endorsed this work.

**`[S]` SOURCED — one thing to know before you perform it.** CPSC's own page states:
...
**Performances to date: none.** As of 2026-08-02, this score has not been performed by anyone,
including its authors. When it has been, the record of that performance — one thing, one
notice, one photograph, one sum — is the thing to show, and this sheet is not.
