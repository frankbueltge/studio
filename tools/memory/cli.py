...
#
# Ported into this repository 2026-08-12 (architect) and fitted to what THIS practice writes —
# deliberately not copied from a sibling's list, since copying a source list that no longer
# matches the work is the exact failure this port exists to correct.
#
# Until now this house had no recall at all. Its constitution names memory as "`memory/`,
# `projects/` and this repository's git history", and by 2026-08-12 that was 585,000 words
# across 232 files — `projects/` alone 277,000, and the *curated* `memory/` itself 86,000. A
# session was told to hold, by reading, what no session can read.
#
